...
int draw_gl_scene(GLvoid)
{
	...
	glRotatef(r_tri, 0.0f, 1.0f, 0.0f);
	glBegin(GL_TRIANGLES);
		glColor3f(1.0f, 0.0f, 0.0f);		// Red
		glVertex3f(0.0f, 1.0f, 0.0f);		// Triange top (front side)
		glColor3f(0.0f, 1.0f, 0.0f);		// Green
		glVertex3f(-1.0f, -1.0f, 1.0f);		// Left point (front side)
		glColor3f(0.0f, 0.0f, 1.0f);		// Blue
		glVertex3f(1.0f, -1.0f, 1.0f);		// Right point (front side)

		glColor3f(1.0f, 0.0f, 0.0f);		// Red
		glVertex3f(0.0f, 1.0f, 0.0f);		// Triange top (right side)
		glColor3f(0.0f, 0.0f, 1.0f);		// Blue
		glVertex3f(1.0f, -1.0f, 1.0f);		// Left point (right side)
		glColor3f(0.0f, 1.0f, 0.0f);		// Green
		glVertex3f(1.0f, -1.0f, -1.0f);		// Right point (right side)

		glColor3f(1.0f, 0.0f, 0.0f);		// Red
		glVertex3f(0.0f, 1.0f, 0.0f);		// Triange top (back side)
		glColor3f(0.0f, 1.0f, 0.0f);		// Green
		glVertex3f(1.0f, -1.0f, -1.0f);		// Left point (back side)
		glColor3f(0.0f, 0.0f, 1.0f);		// Blue
		glVertex3f(-1.0f, -1.0f, -1.0f);	// Right point (right side)

		glColor3f(1.0f, 0.0f, 0.0f);		// Red
		glVertex3f(0.0f, 1.0f, 0.0f);		// Triange top (left side)
		glColor3f(0.0f, 0.0f, 1.0f);		// Blue
		glVertex3f(-1.0f, -1.0f, -1.0f);	// Left point (left side)
		glColor3f(0.0f, 1.0f, 0.0f);		// Green
		glVertex3f(-1.0f, -1.0f, 1.0f);		// Right point (left side)

#if DRAW_BOTTOM_SIDE
		/* Bottom side (1st triangle ) */
		glColor3f(0.0f, 1.0f, 0.0f);		// Green
		glVertex3f(-1.0f, -1.0f, 1.0f);		// Left point (front side)
		glColor3f(0.0f, 0.0f, 1.0f);		// Blue
		glVertex3f(1.0f, -1.0f, 1.0f);		// Left point (right side)
	...
	glRotatef(r_quad, 1.0f, 1.0f, 1.0f);
	glBegin(GL_QUADS);
		/* Quad top */
		glColor3f(0.0f, 1.0f, 0.0f);		// Green
		glVertex3f(1.0f, 1.0f, -1.0f);		// Far right
		glVertex3f(-1.0f, 1.0f, -1.0f);		// Far left
		glVertex3f(-1.0f, 1.0f,	1.0f);		// Near left
		glVertex3f(1.0f, 1.0f, 1.0f);		// Near right
		...
		/* Quad left */
		glColor3f(0.0f, 0.0f, 1.0f);		// Blue
		glVertex3f(-1.0f, 1.0f, 1.0f);		// Near Top
		glVertex3f(-1.0f, 1.0f, -1.0f);		// Far Top
		glVertex3f(-1.0f, -1.0f, -1.0f);	// Far Bottom
		glVertex3f(-1.0f, -1.0f, 1.0f);		// Near Bottom
